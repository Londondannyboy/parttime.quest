    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-600 leading-relaxed mb-6">An <strong>Interim CPO</strong> is a temporary Chief Product Officer who works full-time for a defined period—typically 3-12 months. Unlike fractional CPOs who work part-time, interim CPOs focus exclusively on one organisation during critical product periods.</p>
          <p className="text-gray-600">Interim CPOs are typically hired to lead major product launches, manage strategic pivots, or transform product organisations during periods of intensive change.</p>
        </div>
      </section>
