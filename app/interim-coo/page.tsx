    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-600 leading-relaxed mb-6">An <strong>Interim COO</strong> is a temporary Chief Operating Officer who works full-time for a defined period—typically 3-12 months. Unlike fractional COOs who work part-time, interim COOs focus exclusively on one organisation during their engagement.</p>
          <p className="text-gray-600">Interim COOs are typically hired to lead operational transformations, manage restructuring, or fill leadership gaps during critical growth periods.</p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              { scenario: 'Restructuring', description: 'Major organisational restructuring requiring dedicated operational focus.' },
              ...
              { scenario: 'M&A Integration', description: 'Merging operations post-acquisition with full-time integration leadership.' },
